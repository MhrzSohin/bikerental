      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            ...
            <p>We provide bikes of your's  choice. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>You will be able to fully enjoy your holiday and your ride! Any problems? Our team will be happy to help you!! </p>
    </div>
    <div class="row">
...
<ul>
<li><i class="fa fa-bike" aria-hidden="true"></i><?php echo htmlentities($result->FuelType);?></li>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-motorcycle " aria-hidden="true"></i>0</h2>
            <p> Bikes  Sale</p>
          </div>
        </div>
      </div>
